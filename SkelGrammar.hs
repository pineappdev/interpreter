...
transStmt x = case x of
  ...
  Unpack _ itemq expr -> failure x
  Ass _ final expr -> failure x
  FunDef _ topdef -> failure x
...
transFinal :: Show a => Final a -> Result
transFinal x = case x of
  Final1 _ ident -> failure x
  Final2 _ final expr -> failure x
transItemQ :: Show a => ItemQ a -> Result
transItemQ x = case x of
  ItemQFinal _ final -> failure x
  ItemQTuple _ itemqs -> failure x
transBaseType :: Show a => BaseType a -> Result
transBaseType x = case x of
  IntT _ -> failure x
  StrT _ -> failure x
  BooleanT _ -> failure x
transType :: Show a => Type a -> Result
transType x = case x of
  BaseT _ basetype -> failure x
  ArrayT _ type_ -> failure x
  TupleT _ types -> failure x
transEArg :: Show a => EArg a -> Result
transEArg x = case x of
  EArgE _ expr -> failure x
  EArgName _ ident -> failure x
